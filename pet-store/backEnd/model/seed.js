...
const createProducts = async () => {
    try {
        const products = await Product.bulkCreate([
            ...
            { name: 'Titan Easy-On Pinch Training Collar', category: "Upholstery", animal: "Dog", imageUrl: "https://petproducts.com/cdn/shop/products/55611.jpg?v=1676532821&width=900", description: "The Titan Easy-On Prong Training Collar is the perfect tough, safe and effective training collar for your willful dog. This chrome-plated collar features a nylon loop for optimum durability and strength, and will not tarnish, rust or break.", price: 19.99 },
