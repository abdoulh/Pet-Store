...
const ProductList = ({ item, addToCart, currentUser }) => {
  ...
  return (
    ...
    <div className="col-md-6 col-lg-4 mb-4">
      <div className="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
        ...
        <a className="text-uppercase font-weight-bold" href="" onClick={(e) => { e.preventDefault(); addToCart(currentUser.userId, item.id) }}>Add to cart</a>
      </div>
      {
        modal && (
